...
public class WishAPIConsumerTestRunner implements CommandLineRunner {
	private static final String SERVICE_URL = 
	        "http://localhost:3030/wish-api/wish"; 
	
	@Override
	public void run(String... args) throws Exception {
		RestTemplate template = new RestTemplate() ; 
		
		ResponseEntity<String> res = template.getForEntity(SERVICE_URL, String.class) ; 
        ...
        String resultBody = template.getForObject(SERVICE_URL, String.class);
